...
this is the internal version of {@link org.apache.flink.streaming.api.TimerService} that allows to specify a key and a namespace to which timers should be scoped.
